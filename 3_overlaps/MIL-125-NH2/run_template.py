...
params['lowest_orbital'] = 504-100
params['highest_orbital'] = 504+100
...
if params['is_periodic']:
    params['A_cell_vector'] = [19.041508512536730 ,0.0000000000000000 ,0.0000000000000000]
    params['B_cell_vector'] = [0.0000000000000000 ,19.031220615195195 ,0.0000000000000000]
    params['C_cell_vector'] = [0.0000000000000000 ,0.0000000000000000 ,18.144972135855262]
...
params['trajectory_xyz_filename'] = path + '/../mof_md_1.0fs-pos-1.xyz'
