...
params['istep'] = 
params['fstep'] = 
# Lowest and highest orbital, Here HOMO is 296
params['lowest_orbital'] = 296-100 
params['highest_orbital'] = 296+100
...
if params['is_periodic']:
    params['A_cell_vector'] = [30.0,0.0,0.0]
    params['B_cell_vector'] = [0.0,30.0,0.0]
    params['C_cell_vector'] = [0.0,0.0,30.0]
...
if params['cube_visualization']:
    ...
    params['states_to_plot'] = [295,296,297,298]
...
params['trajectory_xyz_filename'] = path + '/../Si123H100-pos-1.xyz'
