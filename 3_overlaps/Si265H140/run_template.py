...
params['istep'] = 
params['fstep'] = 
# Lowest and highest orbital, Here HOMO is 600
params['lowest_orbital'] = 600-100 
params['highest_orbital'] = 600+200
...
if params['is_periodic']:
    params['A_cell_vector'] = [35.0,0.0,0.0]
    params['B_cell_vector'] = [0.0,35.0,0.0]
    params['C_cell_vector'] = [0.0,0.0,35.0]
...
if params['cube_visualization']:
    ...
    params['states_to_plot'] = [599, 600, 601, 602]
...
params['trajectory_xyz_filename'] = path + '/../Si265H140-pos-1.xyz'
