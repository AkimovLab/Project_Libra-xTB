...
params['istep'] = 
params['fstep'] = 
# Lowest and highest orbital, Here HOMO is 744
params['lowest_orbital'] = 744-100
params['highest_orbital'] = 744+200
...
if params['cube_visualization']:
    ...
    params['states_to_plot'] = [743,744,745,746]
...
params['trajectory_xyz_filename'] = path + '/../Si329H172-pos-1.xyz'
