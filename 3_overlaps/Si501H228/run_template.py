...
params['istep'] = 
params['fstep'] = 
# Lowest and highest orbital, Here HOMO is 1116
params['lowest_orbital'] = 1116-100
params['highest_orbital'] = 1116+201
...
if params['is_periodic']:
    params['A_cell_vector'] = [45.0,0.0,0.0]
    params['B_cell_vector'] = [0.0,45.0,0.0]
    params['C_cell_vector'] = [0.0,0.0,45.0]
...
if params['cube_visualization']:
    ...
    params['states_to_plot'] = [1115,1116,1117,1118]
...
params['trajectory_xyz_filename'] = path + '/../Si501H228-pos-1.xyz'
