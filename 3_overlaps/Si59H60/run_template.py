...
params['istep'] = 
params['fstep'] = 
# Lowest and highest orbital, Here HOMO is 148
params['lowest_orbital'] = 148-50 
params['highest_orbital'] = 148+50
...
if params['is_periodic']:
    params['A_cell_vector'] = [25.0,0.0,0.0]
    params['B_cell_vector'] = [0.0,25.0,0.0]
    params['C_cell_vector'] = [0.0,0.0,25.0]
...
if params['cube_visualization']:
    ...
    params['states_to_plot'] = [147,148,149,150]
...
params['trajectory_xyz_filename'] = path + '/../Si59H60-pos-1.xyz'
